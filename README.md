...
```
java -Dspring.profiles.active=production -jar ./target/aiwingedproject-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=me.sathish/aiwingedproject
```
